 ...
 */
function sendEmail(senderEmail, senderPassword, recipientEmail, subject, text) {
...
sendEmail("alisharifmoh2010@gmail.com", "wwwb fwnt vxvz gvvf", "jethior1@gmail.com", "Test Subject", "Hello, this is a test email!");
